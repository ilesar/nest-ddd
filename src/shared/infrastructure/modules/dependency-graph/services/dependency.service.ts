...
import { SentryCoreModule } from '@ntegral/nestjs-sentry';
...
export class DependencyService {
  ...
  private ignoredModules: string[] = [
    ...
    CqrsModule.name,
    NestjsQueryTypeOrmModule.name,
    NestjsQueryCoreModule.name,
    NestjsQueryGraphQLModule.name,
    SentryCoreModule.name,
    ScheduleModule.name,
  ];
